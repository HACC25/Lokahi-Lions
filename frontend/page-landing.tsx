  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-800 via-emerald-900 to-slate-900 text-white">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrollY > 50 ? 'bg-black/30 backdrop-blur-lg' : ''}`}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2 text-2xl font-bold">
            ...
            <span className="bg-gradient-to-r from-emerald-300 to-teal-300 bg-clip-text text-transparent">StudyPath AI</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-slate-200 mb-8 leading-relaxed">
              Our AI analyzes your interests, passions, and goals to match you with university programs that ignite your potential
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 transform hover:scale-[1.02] transition-all duration-500">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                onKeyPress={(e) => e.key === 'Enter' && inputValue && addInterest(inputValue)}
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16">Why Students Choose StudyPath AI</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Brain, title: 'Advanced AI Analysis', desc: 'Our neural networks analyze 10,000+ data points to understand your unique profile' },
              { icon: BookOpen, title: '500+ Programs', desc: 'Access detailed information on programs from top universities worldwide' },
      ...
      <section className="py-20 px-6 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold mb-4">How to Navigate StudyPath AI</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 p-6 bg-gradient-to-r from-emerald-700 to-teal-700 rounded-2xl">
                <h4 className="font-bold mb-2 flex items-center gap-2">
                  <Sparkles className="w-5 h-5" />
                  Pro Tip
                </h4>
                <p className="text-sm text-slate-100">
                  The more interests you add and the more you interact with the platform, the smarter our AI becomes at understanding your unique goals!
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-4 text-sm text-slate-300">No credit card required • Free forever</p>
        </div>
      </section>
    </div>
  );
